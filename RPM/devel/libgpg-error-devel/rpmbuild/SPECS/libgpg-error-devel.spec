...
ln -s /opt/awn/lib64/libgpg-error.so.0.29.0 %{buildroot}/opt/awn/lib64/libgpg-error.so
ln -s /opt/awn/lib64/libgpg-error.so.0.29.0 %{buildroot}/opt/awn/lib64/libgpg-error.so.0

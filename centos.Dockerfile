...
ENV LIBUUID_DEVEL_RPM_BUILD_DIR ${LIBUUID_DEVEL_RPM_BUILD_DIR:-/root/libuuid-devel/rpmbuild}
...
WORKDIR ${LIBUUID_DEVEL_RPM_BUILD_DIR}
COPY RPM/devel/libuuid-devel/rpmbuild .
RUN set -x && \
  rpmbuild -bb SPECS/libuuid-devel.spec
